...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { content: @tutorial.content, date: @tutorial.date, title: @tutorial.title, videoURL: @tutorial.videoURL }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { content: @tutorial.content, date: @tutorial.date, title: @tutorial.title, videoURL: @tutorial.videoURL }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
